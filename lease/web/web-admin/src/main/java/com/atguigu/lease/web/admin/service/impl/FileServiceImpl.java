...
import com.atguigu.lease.common.minioconfig.MinioProperties;
...
//    }
        return "{" + "  \"Statement\" : [ {" + "    \"Action\" : \"s3:GetObject\"," + "    \"Effect\" : \"Allow\"," + "    \"Principal\" : \"*\"," + "    \"Resource\" : \"arn:aws:s3:::" + bucketName + "/*\"" + "  } ]," + "  \"Version\" : \"2012-10-17\"" + "}";
    }
}
